...
import { TektonHubPipelineDatasource, TektonHubTaskDatasource } from './tekton';
...
api.set(TektonHubTaskDatasource.id, new TektonHubTaskDatasource());
api.set(TektonHubPipelineDatasource.id, new TektonHubPipelineDatasource());
